...
# You must run the command using: bash prep_and_deploycc_azurecloudshell.sh, otherwise it will fail
# This version of the script will take the prep work, then insert variables into tfvars, then start the deployment
set -e
...
# Run the terraform deployment script next
bash zsec up